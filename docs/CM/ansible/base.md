...
Ansible有非常多的模块，在这个页面[https://docs.ansible.com/ansible/latest/collections/index_module.html](https://docs.ansible.com/ansible/latest/collections/index_module.html)可以查看到所有的模块列表。
